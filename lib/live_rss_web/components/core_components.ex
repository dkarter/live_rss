defmodule LiveRSSWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(LiveRSSWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(LiveRSSWeb.Gettext, "errors", msg, opts)
    # end
